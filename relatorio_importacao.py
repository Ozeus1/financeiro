...
balancos = cursor.execute('SELECT COUNT(*) FROM balancos_mensal').fetchone()[0]
eventos = cursor.execute('SELECT COUNT(*) FROM eventos_caixa_avulso').fetchone()[0]
